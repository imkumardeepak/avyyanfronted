...
const SalesOrderItemProcessing = () => {
  ...
  useEffect(() => {
    ...
    if (locationState?.orderData && locationState?.selectedItem) {
      ...
      setRollInput(prev => ({ 
        ...prev, 
        actualQuantity: parseFloat(locationState.selectedItem?.actualQty || '0') || prev.actualQuantity 
      }));
  ...
  const parsedDescriptionValues = useMemo(() => {
    return selectedItem?.descriptions ? parseDescriptionValues(selectedItem.descriptions) : { 
      stitchLength: 0, 
      count: 0, 
      weightPerRoll: 0,
      numberOfRolls: 0,
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
      ...
      productionCalc.stichLength, productionCalc.count, productionCalc.efficiency]);
  ...
  const updateMachineParameters = (machineId: number, parameters: Partial<{
    needle: number;
    feeder: number;
    rpm: number;
    efficiency: number;
...
const updateMachineAllocation = (machineId: number, allocatedWeight: number) => {
  ...
  const actualQuantity = Number(rollInput.actualQuantity) || 0;
  const currentTotalAllocated = selectedMachines.reduce((sum, m) => 
    m.machineId === machineId ? sum : sum + m.allocatedWeight, 0);
  ...
  if (newTotalAllocated > actualQuantity) {
    ...
    console.warn(`Total allocated weight (${newTotalAllocated.toFixed(2)} kg) exceeds actual quantity (${actualQuantity.toFixed(2)} kg)`);
  }
...
const autoDistributeLoad = () => {
  ...
  const handleProcessItem = async () => {
    ...
    try {
      ...
      const fabricType = extractFabricTypeFromDescription(selectedItem.descriptions || '') || extractFabricType(selectedItem.stockItemName);
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Processing Item: <span className="font-semibold text-primary">{selectedItem?.stockItemName}</span>
            </p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              <div className="text-2xl font-bold text-yellow-600 font-mono">₹{selectedItem.amount}</div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="text-sm">{selectedItem.descriptions || 'No description available'}</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleAdditionalFieldChange('reqGreyGsm', e.target.value ? parseFloat(e.target.value) : null)}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleAdditionalFieldChange('reqGreyWidth', e.target.value ? parseFloat(e.target.value) : null)}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleAdditionalFieldChange('reqFinishGsm', e.target.value ? parseFloat(e.target.value) : null)}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleAdditionalFieldChange('reqFinishWidth', e.target.value ? parseFloat(e.target.value) : null)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleRollInputChange('actualQuantity', parseFloat(e.target.value) || 0)}
                  className="text-center font-mono"
                />
                <div className="text-xs text-muted-foreground">
                  From Sales Order: {typeof selectedItem.actualQty === 'string' 
                    ? parseFloat(selectedItem.actualQty) || 0 
                    : selectedItem.actualQty || 0} kg
                </div>
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleRollInputChange('rollPerKg', parseFloat(e.target.value) || 0)}
                  className="text-center font-mono"
                />
                <div className="text-xs text-muted-foreground">
                  {parsedDescriptionValues.weightPerRoll > 0 ? (
                    <span className="text-green-600">✓ Auto-parsed from description: {parsedDescriptionValues.weightPerRoll} kg/roll</span>
                  ) : parsedDescriptionValues.numberOfRolls > 0 ? (
                    <span className="text-green-600">✓ Calculated from {parsedDescriptionValues.numberOfRolls} rolls</span>
                  ) : (
                    <span className="text-orange-600">⚠ Enter manually (not found in description)</span>
                  )}
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-bold text-blue-800">
                      ...
                      {rollCalculation.totalWholeRolls === 0 && rollCalculation.fractionalRoll > 0 &&
                        `1 roll × ${rollCalculation.fractionalWeight.toFixed(2)}kg`}
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  {isLoadingMachines ? (
                    ...
                    <Select value={machineSelection.selectedMachine?.id.toString() || ''} onValueChange={handleMachineChange}>
                ...
                <div className="space-y-2">
                  ...
                  {machineSelection.selectedMachine ? (
                    <div className="p-3 bg-gray-50 rounded text-sm">
                      <p><strong>Name:</strong> {machineSelection.selectedMachine.machineName}</p>
                      <p><strong>Diameter:</strong> {machineSelection.selectedMachine.dia}"</p>
                      <p><strong>Gauge:</strong> {machineSelection.selectedMachine.gg}</p>
                      <p><strong>Efficiency:</strong> {machineSelection.selectedMachine.efficiency}%</p>
                    </div>
                  ) : (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleProductionValueChange('efficiency', Number(e.target.value))}
                    className="text-center font-mono"
                  />
                </div>
              </div>
                    ...
                    {(() => {
                      return (
                        <div className="space-y-1">
                          ...
                          <p>• Stitch Length (S.L.): {parsedDescriptionValues.stitchLength > 0 ? `${parsedDescriptionValues.stitchLength}` : 'Not found'}</p>
                          <p>• Count: {parsedDescriptionValues.count > 0 ? `${parsedDescriptionValues.count}` : 'Not found'}</p>
                          <p>• Weight per Roll: {parsedDescriptionValues.weightPerRoll > 0 ? `${parsedDescriptionValues.weightPerRoll} kg/roll` : 'Not found'}</p>
                          <p>• Number of Rolls: {parsedDescriptionValues.numberOfRolls > 0 ? `${parsedDescriptionValues.numberOfRolls}` : 'Not found'}</p>
                          <p>• Diameter: {parsedDescriptionValues.diameter > 0 ? `${parsedDescriptionValues.diameter}"` : 'Not found'}</p>
                          <p>• Gauge: {parsedDescriptionValues.gauge > 0 ? `${parsedDescriptionValues.gauge}` : 'Not found'}</p>
                          ...
                          <div className="mt-2 p-1 bg-yellow-100 rounded text-xs">
                            ...
                            <p>• Weight per Roll: "Wt./Roll: 30 Kg/Roll", "30 kg/roll", "weight per roll 30kg", "Roll: 30 kg"</p>
                            <p>• Number of Rolls: "No Of Rolls: 50", "Number of Rolls: 50", "Rolls: 50"</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleProductionValueChange('stichLength', Number(e.target.value))}
                    className="text-center font-mono"
                    placeholder="Enter S.L. value"
                  />
                  <div className="text-xs text-muted-foreground">
                    {parsedDescriptionValues.stitchLength > 0 ? (
                      <span className="text-green-600">✓ Auto-parsed from description: {parsedDescriptionValues.stitchLength}</span>
                    ) : (
                      <span className="text-orange-600">⚠ Enter manually (not found in description)</span>
                    )}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {parsedDescriptionValues.count > 0 ? (
                      <span className="text-green-600">✓ Auto-parsed from description: {parsedDescriptionValues.count}</span>
                    ) : (
                      <span className="text-orange-600">⚠ Enter manually (not found in description)</span>
                    )}
                  </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="space-y-3">
                  <div className="text-sm font-mono text-center">
                    <strong>Formula:</strong> PRODUCTION = (Needles × Feeders × RPM × S.L. × 0.00085 × Efficiency%) ÷ Count
                  </div>
                  <div className="text-sm font-mono text-center text-blue-700">
                    = ({productionCalc.needle} × {productionCalc.feeder} × {productionCalc.rpm} × {productionCalc.stichLength} × {productionCalc.constant} × {productionCalc.efficiency}%) ÷ {productionCalc.count}
                  </div>
            ...
            {isLoadingFabrics ? (
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h4 className="font-semibold text-green-800 mb-2">Fabric Information & Efficiency</h4>
                <div className="text-sm text-green-700">
                  <p><strong>Item:</strong> {selectedItem?.stockItemName}</p >
                  <p><strong>Efficiency Source:</strong> 
                    {(() => {
                      // Updated to use description for fabric type matching
                      let itemFabricType = '';
                      ...
                      return matchingFabric ? (
                        <span className="text-green-600">✓ Auto-detected: {matchingFabric.fabricstr} ({matchingFabric.standardeffencny}%)</span>
                      ) : (
                        <span className="text-orange-600">⚠ Using default efficiency (85%)</span>
                      );
                    })()} 
                  </p>
                  <p><strong>Current Efficiency:</strong> {productionCalc.efficiency}%</p>
                  {selectedMachines.length > 0 && (
                    <div className="mt-2 p-2 bg-green-100 rounded">
                      <p className="text-xs font-medium text-green-800">Machine Parameters Auto-Loaded:</p>
                      <p className="text-xs text-green-700">
                        All selected machines have their original parameters (needles, feeders, RPM, efficiency) 
                        automatically fetched and can be edited individually for precise calculations.
                      </p>
                    </div>
                  )}
                </div>
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  ...
                                  <p className="text-xs text-gray-600">
                                    Dia: {machine.dia}" | GG: {machine.gg} | Eff: {machine.efficiency}%
                                  </p>
                                </div>
                  ...
                  {selectedMachines.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="font-medium text-green-800">Load Distribution ({selectedMachines.length} machines)</h4>
                      ...
                      <div className="space-y-3">
                        {selectedMachines.map((machine) => {
                          ...
                          return (
                            <div key={machine.machineId} className="bg-white border border-green-300 rounded-lg p-3">
                              {/* Machine Header */}
                              <div className="flex items-center justify-between mb-3">
                                <div>
                                  <p className="font-medium text-sm">{machine.machineName}</p>
                                  <p className="text-xs text-gray-600">
                                    Dia: {machineData?.dia}" | GG: {machineData?.gg} | Base Eff: {params.efficiency}%
                                  </p>
                                </div>
                                <div className="flex space-x-2">
                                  <Button
                                    onClick={() => machine.isEditing ? saveMachineParameters(machine.machineId) : toggleMachineEdit(machine.machineId)}
                                    size="sm"
                              ...
                              {machine.isEditing && (
                                <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded">
                                  <h5 className="font-medium text-blue-800 mb-2">Machine Parameters</h5>
                                  <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                                    <div className="space-y-1">
                                      ...
                                      <Input
                                        type="number"
                                        value={params.needle}
                                        onChange={(e) => updateMachineParameters(machine.machineId, { needle: Number(e.target.value) })}
                                    ...
                                    <div className="space-y-1">
                                      ...
                                      <Input
                                        type="number"
                                        value={params.feeder}
                                        onChange={(e) => updateMachineParameters(machine.machineId, { feeder: Number(e.target.value) })}
                                        className="text-center text-xs h-7"
                                      />
                                    </div>
                                    <div className="space-y-1">
                                      ...
                                      <Input
                                        type="number"
                                        value={params.rpm}
                                        onChange={(e) => updateMachineParameters(machine.machineId, { rpm: Number(e.target.value) })}
                                        className="text-center text-xs h-7"
                                      />
                                    </div>
                                    <div className="space-y-1">
                                      ...
                                      <Input
                                        ...
                                        onChange={(e) => updateMachineParameters(machine.machineId, { efficiency: Number(e.target.value) })}
                                        className="text-center text-xs h-7"
                                      />
                                    </div>
                                    <div className="space-y-1">
                                      ...
                                      <Input
                                        ...
                                        onChange={(e) => updateMachineParameters(machine.machineId, { constant: Number(e.target.value) })}
                                        className="text-center text-xs h-7"
                                      />
                                    </div>
                                  </div>
                                  ...
                                  <Input
                                    ...
                                    className={`text-center text-xs h-8 ${
                                      (() => {
                                        ...
                                        const currentTotalAllocated = selectedMachines.reduce((sum, m) => 
                                          m.machineId === machine.machineId ? sum : sum + m.allocatedWeight, 0);
                                        const newTotalAllocated = currentTotalAllocated + machine.allocatedWeight;
                                        const actualQuantity = Number(rollInput.actualQuantity) || 0;
                                        return newTotalAllocated > actualQuantity ? "border-red-500 border-2" : "";
                                      })()
                                    }`}
                                  />
                                </div>
                                  ...
                                  <p className="font-medium text-xs">
                                    {machine.allocatedRolls > 0 && rollInput.rollPerKg > 0 ? (
                                      (() => {
                                        ...
                                        if (fractionalPart > 0) {
                                          // Has fractional part
                                          const fractionalWeight = fractionalPart * rollInput.rollPerKg;
                      ...
                      <div className="mt-4 p-3 rounded border">
                        {(() => {
                          ...
                          return (
                            <div className={isOverAllocated ? "bg-red-100 border-red-300" : "bg-green-100 border-green-300"}>
                              <h5 className={`font-medium mb-2 ${isOverAllocated ? "text-red-800" : "text-green-800"}`}>
                                Distribution Summary
                                {isOverAllocated && (
                                  <span className="ml-2 text-red-600 font-bold">⚠ OVER ALLOCATED!</span>
                                )}
                              </h5>
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                <div>
                                  <p className={isOverAllocated ? "text-red-600" : "text-green-600"}>Total Allocated Weight:</p>
                                  <p className={`font-bold ${isOverAllocated ? "text-red-800" : "text-green-800"}`}>
                                ...
                                <div>
                                  <p className={isOverAllocated ? "text-red-600" : "text-green-600"}>Remaining:</p>
                                  <p className={`font-bold ${remaining >= 0 ? (isOverAllocated ? "text-red-800" : "text-green-800") : "text-red-800"}`}>
                                ...
                                <div>
                                  <p className={isOverAllocated ? "text-red-600" : "text-green-600"}>Total Machine Distribution Time:</p>
                                  <p className={`font-bold ${isOverAllocated ? "text-red-800" : "text-green-800"}`}>
                                    {selectedMachines.reduce((sum, m) => sum + m.estimatedProductionTime, 0).toFixed(1)}h
                                  </p>
                                </div>
                              </div>
                              {isOverAllocated && (
                                <div className="mt-2 p-2 bg-red-200 rounded text-red-800 text-sm">
                                  ⚠ Warning: Total allocated weight ({totalAllocated.toFixed(2)} kg) exceeds actual quantity ({actualQuantity.toFixed(2)} kg).
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg bg-green-50 border-green-200">
                <div>
                  ...
                  <p className="text-sm text-green-600">
                    Process "{selectedItem?.stockItemName}" from order {selectedOrder?.voucherNumber}
                  </p>
                </div>
                <Button 
                  onClick={handleProcessItem} 
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg bg-yellow-50 border-yellow-200">
                <div>
                  ...
                  <p className="text-sm text-yellow-600">
                    "{selectedItem?.stockItemName}" from order {selectedOrder?.voucherNumber} is currently being processed
                  </p>
                </div>
